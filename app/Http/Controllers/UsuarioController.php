...
class UsuarioController extends Controller
{
    ...
    public function carrito(){
        ...
        foreach($carrito as $item){
            ...
            $total = $total + $subtotal;  
               ...
               $PrecioX =   str_replace('.', '',$item->precio_ahora) ;
               $CantidadX =  $item->cantidad;
               $subtotal2 =  $PrecioX * $CantidadX;
               $totaltarjeta = $totaltarjeta + $subtotal2;  
        ...
        return view('perfil.carrito',compact('totaltarjeta','carrito','direcciones','total','authenticate','data_productos','data_cantidades','config'));
    }
    ...
    public function checkout($codigo,$transaccion,$productos,$cantidades,$direccion,$total,$currency,$metodo){
        ...
        try { 
            ...
            Session::flash('success', 'Se procesó la compra correctamente, No olvide dejar un numero de whatsapp/cel en su configuración de usuario para poder comunicarnos con usted, Gracias. ');
