...
{{--     <div class="banner banner-cat" style="background-image: url('assets/images/banners/banner-top.jpg');">
        <div class="banner-content container">
            ...
            <h1 class="banner-title">
                Disfruta comprar en MinkaMarket
            </h1>
                        ...
                        <div class="col-6 col-md-3">
                            <div class="product-default">
                                ...
                                <div class="product-details">
                                    ...
                                    <input class="horizontal-quantity form-control"   id="cantidad" name="cantidad" type="text"></div>
                                       
                                        <button class="btn btn-outline-primary btn-rounded waves-effect" type="submit"><i class="icon-bag"></i>Agregar</button>  
                                            </form>
            ...
            <aside class="sidebar-shop col-lg-3 order-lg-first">
                <div class="sidebar-wrapper">
                    ...
                    <div class="widget">
                                ...
                                <ul class="cat-list">
                                    <li>
                                        {!! Form::open(array('url'=>'productos','method'=>'GET','autocomplete'=>'off','role'=>'search'))!!}
                                            ...
                                            <button type="submit" class="btn-marca">Elite</button>
                                        {{Form::close()}}
                                    </li>
                                    <li>
                                        {!! Form::open(array('url'=>'productos','method'=>'GET','autocomplete'=>'off','role'=>'search'))!!}
                                            <input type="hidden" name="marca" value="xiaomi">
                                            <button type="submit" class="btn-marca">Florida</button>
                                        {{Form::close()}}
                                    </li>
                                    <li>
                                        {!! Form::open(array('url'=>'productos','method'=>'GET','autocomplete'=>'off','role'=>'search'))!!}
                                            <input type="hidden" name="marca" value="sapoleo">
                                            <button type="submit" class="btn-marca">Sapoleo</button>
                                        {{Form::close()}}
                                    </li>
                                    <li>
                                        {!! Form::open(array('url'=>'productos','method'=>'GET','autocomplete'=>'off','role'=>'search'))!!}
                                            <input type="hidden" name="marca" value="gloria">
                                            <button type="submit" class="btn-marca">Gloria</button>
                                        {{Form::close()}}
                                    </li>
                                    <li>
                                        {!! Form::open(array('url'=>'productos','method'=>'GET','autocomplete'=>'off','role'=>'search'))!!}
                                            <input type="hidden" name="marca" value="huawei">
                                            <button type="submit" class="btn-marca">Nestle</button>
                                        {{Form::close()}}
                                    </li>
                                        <li>
                                        {!! Form::open(array('url'=>'productos','method'=>'GET','autocomplete'=>'off','role'=>'search'))!!}
                                            <input type="hidden" name="marca" value="huawei">
                                            <button type="submit" class="btn-marca">Cristal</button>
                                        {{Form::close()}}
                                    </li>
                        ...
                        <div class="widget">
                        <h3 class="widget-title">
                            <a data-toggle="collapse" href="#widget-body-4" role="button" aria-expanded="true" aria-controls="widget-body-4">Buscar Por</a>
                        </h3>
                            ...
                            <div class="widget-body">
                                <ul class="cat-list">
                                    <li>
                                        {!! Form::open(array('url'=>'productos','method'=>'GET','autocomplete'=>'off','role'=>'search'))!!}
                                            <input type="hidden" name="marca" value="adidas">
                                            <button type="submit" class="btn-marca">Fideo</button>
                                        {{Form::close()}}
                                    </li>
                                    <li>
                                        {!! Form::open(array('url'=>'productos','method'=>'GET','autocomplete'=>'off','role'=>'search'))!!}
                                            <input type="hidden" name="marca" value="adidas">
                                            <button type="submit" class="btn-marca">Papel</button>
                                        {{Form::close()}}
                                    </li>
                                       <li>
                                        {!! Form::open(array('url'=>'productos','method'=>'GET','autocomplete'=>'off','role'=>'search'))!!}
                                            <input type="hidden" name="marca" value="adidas">
                                            <button type="submit" class="btn-marca">Atun</button>
                                        {{Form::close()}}
                                    </li>
                                    <li>
                                        {!! Form::open(array('url'=>'productos','method'=>'GET','autocomplete'=>'off','role'=>'search'))!!}
                                            <input type="hidden" name="marca" value="adidas">
                                            <button type="submit" class="btn-marca">Menestra</button>
                                        {{Form::close()}}
                                    </li>
                                      <li>
                                        {!! Form::open(array('url'=>'productos','method'=>'GET','autocomplete'=>'off','role'=>'search'))!!}
                                            <input type="hidden" name="marca" value="adidas">
                                            <button type="submit" class="btn-marca">Detergente</button>
                                        {{Form::close()}}
                                    </li>
