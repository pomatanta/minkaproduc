                               ...
                               @if (Auth::check())
                                    <form action="{{route('agregar.carrito')}}" method="POST">
                                        ...
                                        <div class="product-action product-all-icons">
                                            ...
                                            <button type="submit" class="btn btn-outline-primary btn-rounded waves-effect" title="Agregar" style="cursor: pointer">
                                                <span>Agregar</span>
                                            </button>
                                ...
                                @else
                                    ...
                                    <div class="product-action product-all-icons">
                                        ...
                                        <button  id="buyButtonx"  class="btn btn-outline-primary btn-rounded waves-effect" title="Agregar al carrito" style="cursor: pointer">
                    ...
                    <div class="widget widget-info">
                        <ul>
                            <li>
                                ...
                                <h4>ENVIO A CARABAYLLO<br>COMAS, OLIVOS</h4>
                            </li>
                            <li>
...
@push('scripts')
<script>
  $('#buyButtonx').on('click', function(e) {
    // Abre el formulario con las opciones de Culqi.settings
 
   return window.location="/sesion";
