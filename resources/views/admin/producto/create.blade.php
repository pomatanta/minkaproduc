                                                ...
                                                <div class="col-lg-8">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-3 form-group">
                                                            ...
                                                            <input type="number" name="precio_antes" step="any" class="form-control {{ $errors->has('precio_antes') ? ' is-invalid' : '' }}" autocomplete="new-text" value="{{old('precio_antes')}}" placeholder="0.0">
                                                        ...
                                                        <div class="col-lg-3 form-group">
                                                            ...
                                                            <input type="number" name="precio_ahora" step="any" class="form-control {{ $errors->has('precio_ahora') ? ' is-invalid' : '' }}" autocomplete="new-text" value="{{old('precio_ahora')}}" placeholder="0.0">
