                        ...
                        <div class="card" style="background: #e8e8e8 !important">
                            ...
                            <div class="card-body">
                                ...
                                <div class="row form-group">
                                    ...
                                    <div class="col-lg-8">
                                        <input type="text" required class="form-control" name="culqui_key_public" placeholder="Llave publica11" value="{{$config->culqui_key_public}}">
                                ...
                                <div class="row form-group">
                                    ...
                                    <div class="col-lg-8">
                                        <input type="text" required class="form-control" name="culqui_key_private" placeholder="Llave privadaxxx" value="{{$config->culqui_key_private}}">
