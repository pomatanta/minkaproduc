            ...
            <div class="col-lg-9">
                <div class="home-slider owl-carousel owl-carousel-lazy owl-theme owl-theme-light">
                    <div class="home-slide">
                        <div class="owl-lazy slide-bg" data-src="assets/images/slider/Bannx1.png"></div>
...
{{-- 
 ...
 --}}
                ...
                <div class="mb-3"></div><!-- margin -->
                 <h3 class="title">Mas buscados</h3>
                ...
                <div class="row">
                    <div class="col-sm-7 col-md-4">
                        <div class="feature-box feature-box-simple text-center">
                            ...
                            <div class="feature-box-content">
                                <h3>Seguridad</h3>
                                <p>Recibe tus productos con los protocolos de seguridad en tu Hogar</p>
                    ...
                    <div class="col-sm-7 col-md-4">
                        <div class="feature-box feature-box-simple text-center">
                            ...
                            <div class="feature-box-content">
                                <h3>Buen Trato</h3>
                                <p>Nuestro personal siempre estara pendiente de nuestros clientes para tener una buena experiencia de compra </p>
                    ...
                    <div class="col-sm-6 col-md-4">
                        <div class="feature-box feature-box-simple text-center">
                            ...
                            <div class="feature-box-content">
                                ...
                                <p>Minka market tiene como compromiso que los productos lleguen en buen estado a su hogar</p>
                                {{-- <a href="#" class="btn btn-outline-dark">Lear More</a> --}}
                            </div><!-- End .feature-box-content -->
                        </div><!-- End .feature-box -->
                    </div><!-- End .col-md-4 -->
                    ...
                    <div class="widget-testimonials-slider owl-carousel owl-theme">
                        <div class="testimonial">
                            <div class="testimonial-owner">
                               ...
                               {{--      <img src="assets/images/clients/client1.png" alt="client"> --}}
                                ...
                                <div>
                                    <h4 class="testimonial-title">Minka Market</h4>
                           {{--          <span>CEO &amp; Founder</span> --}}
                                </div>
                            </div><!-- End .testimonial-owner -->

                            <blockquote>
                                <p>Inicia sesión  , selecciona tus productos , elije la cantidad  y compralo de la forma que quieras </p>
                            </blockquote>
                        </div><!-- End .testimonial -->
                        ...
                        <div class="testimonial">
                         ...
                         {{--            <span>Co-founder</span> --}}
                            ...
                            <blockquote>
                                <p>Los productos son desinfectado antes y despues de la entrega protegiendo tu salud y la de tu familia</p>
                            </blockquote>
                        </div><!-- End .testimonial -->
